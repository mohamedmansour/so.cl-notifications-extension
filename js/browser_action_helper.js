 ...
 * rounded rectangles.
 *
 * @author hello@mohamedmansour.com (Mohamed Mansour)
 * @author kaktus621@gmail.com (Martin Matysiak)
 */

 BrowserActionRenderer = function() {};
 ...
 */
BrowserActionRenderer.prototype.drawBadgeIcon = function(count, newItem) {
  ...
  var browserActionText = count + ' notifications on so.cl!';
  if (count > 99){
    ...
    if (count == 0) {
      browserActionText = 'There are no notifications on so.cl going on!';
    }
  }
  else {
    ctx.fillText('?', 6, 14);
    browserActionText = 'Your session to so.cl was not found, please log in or reopen Chrome.';
  }
